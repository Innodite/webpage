...
<div id="sticky_navigation">
	<nav id="nav">
            ...
            <ul class="colapse_options">
                ...
                <li id="imp4"><a href="#">Blog</a></li>
                <li id="imp5"><a href="#">Nosotros</a></li>
                <li id="imp6"><a href="#">Contacto</a></li>
            </ul>
            <ul class="thick">
                <li id="im1"><a href="index.php">Inicio</a></li>
                <li id="im2"><a href="servicios.php">Servicios</a></li>
                <li id="im3"><a href="portafolio.php">Portafolio</a></li>
                <li id="im4"><a href="#">Blog</a></li>
